...
7. Atualize data e validade da cotação em `Premissas`.

Não há busca periódica automática. Isso evita preços duvidosos e mantém o app 100% local enquanto a base oficial ou normalizada é importada pelo usuário.
